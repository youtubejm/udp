...
int main(int argc, char *argv[ ])
{
	...
	if(argc < 6){
		fprintf(stderr, "\x1b[1;31mÐ¡Ð¾Ð·Ð´Ð°Ð½Ð¾ \x1b[0;31mflexingonlamers\n");
		fprintf(stdout, "\x1b[0;32mÐ²Ð²ÐµÐ´Ð¸Ñ‚Ðµ ÑÐ»ÐµÐ´ÑƒÑŽÑ‰ÐµÐµ:\x1b[1;34m %s \x1b[0;34mRange Start 198.0.0.1 \x1b[1;33mEnd Range 192.168.255.255 \x1b[0;36mOUTPUT \x1b[0;31mThreads \x1b[1;35m MS Delay\n", argv[0]);
		exit(-1);
	}
	fd = fopen(argv[3], "a");
	...
	sleep(1);
	printf("ÑÐºÐ°Ð½Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ðµ...\n");
